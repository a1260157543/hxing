...
import com.easemob.lamb.ui.LoginActivity;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					URL url = new URL("https://a1260157543.github.io/lamb/check.json");
			...
			public void onCancel(DialogInterface dialog) {
		       ...
		       .setPositiveButton("更新", new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					//访问网络，下载新的apk
					Intent it = new Intent(Intent.ACTION_VIEW, Uri.parse("https://a1260157543.github.io/lamb/Lamb.apk"));
