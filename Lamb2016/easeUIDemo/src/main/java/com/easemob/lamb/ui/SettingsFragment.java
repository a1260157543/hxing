...
import com.easemob.lamb.DemoModel;
import com.easemob.lamb.R;
import com.easemob.easeui.widget.EaseSwitchButton;
import com.easemob.lamb.db.appupdate.*;
...
public class SettingsFragment extends Fragment implements OnClickListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		update = (LinearLayout) getView().findViewById(R.id.update);
	...
	public void onClick(View v) {
		...
		case R.id.ll_user_profile:
			...
			break;
		case R.id.update:
			Intent intent = new Intent(getActivity(), com.easemob.lamb.db.appupdate.SplashActivity.class);
